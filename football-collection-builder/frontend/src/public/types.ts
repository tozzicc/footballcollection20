...
export interface PublicCountry { slug:string; name:string; teamsCount:number; collectionsCount:number; itemsCount:number; primaryMedia:PublicMedia|null; logoMedia:PublicMedia|null }
export interface PublicTeam { slug:string; countrySlug:string; name:string; collectionsCount:number; itemsCount:number; imagesCount:number; latestInclusionPeriod:string|null; primaryMedia:PublicMedia|null; logoMedia:PublicMedia|null }
...
export interface SearchResult { type:'country'|'team'|'collection'|'item'|'editorial'; title:string; subtitle?:string; countrySlug?:string|null; teamSlug?:string|null; collectionSlug?:string|null; itemSlug?:string|null; publicRoute?:string|null; primaryMedia:PublicMedia|null }
...
export interface SeasonDetail { country:PublicCountry; team:PublicTeam; season:string; records:PublicItem[]; summary:{records:number;images:number} }
